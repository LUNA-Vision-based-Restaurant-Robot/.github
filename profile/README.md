...
\textbf{Tools \& technologies used:} ROS 1 Noetic Ninjemys, TensorFlow, OpenCV, Open3D, Python, C++ with \\
        Atmega2560 custom PCB for Motor and stability Control, Raspberry Pi, Kinect v2 depth camera
